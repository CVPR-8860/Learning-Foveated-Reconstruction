...
def save_image_data(input_path, output_path, size, sampling_rate):
...
def load_images(input_directory, output_directory, image_size, sampling_rate):
    all_image_paths = glob(f'{input_directory}/*.png')
    for image_path in all_image_paths:
        save_image_data(image_path, output_directory, size=image_size, sampling_rate=sampling_rate)
